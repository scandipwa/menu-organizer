<?php
namespace ScandiPWA\MenuOrganizer\Block\Adminhtml\Menu;
...
class Edit extends Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('ScandiPWA_MenuOrganizer::navigation_menu_save')) {
        ...
        if ($this->_isAllowedAction('ScandiPWA_MenuOrganizer::navigation_menu_delete')) {
    ...
    {
        $menu = $this->_coreRegistry->registry('scandipwa_menuorganizer_menu');
